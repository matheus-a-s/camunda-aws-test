...
// import static
// io.camunda.zeebe.spring.test.ZeebeTestThreadSupport.waitForProcessInstanceCompleted;
// import static
// io.camunda.zeebe.spring.test.ZeebeTestThreadSupport.waitForProcessInstanceHasPassedElement;
...
// */
// @SpringBootTest(classes = ProcessApplication.class) // will deploy BPMN & DMN
// models
// @ZeebeSpringTest
...
// when(myService.myOperation(anyString())).thenReturn("232");

// // prepare data
// final ProcessVariables variables = new
// ProcessVariables().setBusinessKey("23");
...
// waitForProcessInstanceHasPassedElement(processInstance,
// "Task_InvokeService");
